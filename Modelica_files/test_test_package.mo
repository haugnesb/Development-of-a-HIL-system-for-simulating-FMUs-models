package TestPackage
  ...
  package ActiveWork
    package MotorTest
      ...
      model T2
        ...
        Modelica.Blocks.Logical.GreaterThreshold greaterThreshold annotation(
          Placement(visible = true, transformation(origin = {49, 69}, extent = {{-7, -7}, {7, 7}}, rotation = 0)));
        Modelica.Blocks.Sources.Ramp ramp(duration = TestMotorTorqueDuration, height = -4, offset = 8, startTime = 20) annotation(
          Placement(visible = true, transformation(origin = {68, -24}, extent = {{-80, 40}, {-60, 60}}, rotation = 0)));
    ...
    package WaterModel
      ...
      equation
        ...
        connect(testSimpleHPL.Torque_Out, division.u1) annotation(
          Line(points = {{-76, 84.2}, {-68, 84.2}, {-68, 84}, {-58, 84}}, color = {0, 0, 127}));
        connect(and1.y, booleanToReal.u) annotation(
        ...
        connect(greaterEqual.u1, division.y) annotation(
          Line(points = {{-44, 4}, {-56, 4}, {-56, 8}, {-68, 8}, {-68, 46}, {-24, 46}, {-24, 78}, {-35, 78}}, color = {0, 0, 127}));
        annotation(
      ...
      equation
        ...
        connect(division.u1, testSimpleHPL2.Torque_Out) annotation(
          Line(points = {{10, 72}, {6, 72}, {6, 72.2}, {0, 72.2}}, color = {0, 0, 127}));
        connect(booleanToReal.y, product.u2) annotation(
      ...
      model Simple "Model of a hydropower system with a simple turbine turbine"
        ...
        replaceable OpenHPL.Waterway.Pipe penstock(D_i = 3, D_o = 3, H = 428.5, L = 600, vertical = true) constrainedby OpenHPL.Interfaces.TwoContact annotation(
           Placement(transformation(origin = {0, 30}, extent = {{-10, -10}, {10, 10}})));
        OpenHPL.Waterway.SurgeTank surgeTank(h_0 = 69.9) annotation(
          Placement(transformation(origin = {-30, 30}, extent = {{-10, -10}, {10, 10}})));
        OpenHPL.ElectroMech.Turbines.Turbine turbine(C_v = 3.7, ConstEfficiency = false, enable_nomSpeed = true, enable_f = false, enable_P_out = true) annotation(
        ...
        Modelica.Blocks.Interfaces.RealOutput P_out1 "Mechanical Output power" annotation(
          Placement(transformation(extent = {{102, 60}, {122, 80}})));
      equation
        ...
        connect(turbine.P_out, P_out1) annotation(
          Line(points = {{34, 21}, {38, 21}, {38, 70}, {112, 70}}, color = {0, 0, 127}));
        annotation(
      ...
      model HPM
        ...
        Modelica.Blocks.Interfaces.RealOutput SM_Start_Torque_out annotation(
          Placement(visible = true, transformation(origin = {110, -40}, extent = {{-10, -10}, {10, 10}}, rotation = 0), iconTransformation(origin = {146, -58}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
        Modelica.Blocks.Sources.Step step(height = 1, offset = 0, startTime = 0.001) annotation(
  ...
  Modelica.Blocks.Sources.Constant W_in_constant(k = 12) annotation(
    ...
    equation
      ...
      connect(W_in, div0protect.u) annotation(
        Line(points = {{-120, -42}, {46, -42}, {46, 26}, {54, 26}}, color = {0, 0, 127}));
      connect(W_in, addd.u1) annotation(
  ...
  connect(hpm4.Tourque_out, SignalChecker.Torque_In) annotation(
        Line(points = {{8, 16}, {16, 16}, {16, 8}, {26, 8}}, color = {0, 0, 127}));
  connect(hpm4.W_in, sMModel1.SM_w_out) annotation(
        Line(points = {{-16, 8}, {-24, 8}, {-24, 18}, {-44, 18}}, color = {0, 0, 127}));
      annotation(
        experiment(StartTime = 0, StopTime = 300, Tolerance = 1e-06, Interval = 0.6),
        __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian --fmuCMakeBuild=true --fmuRuntimeDepends=none ");
    end HydroM4;
  ...
  connect(SM_w_out, SpeedConv.y) annotation(
        Line(points = {{112, 80}, {-30, 80}}, color = {0, 0, 127}));
      annotation(
        Icon(coordinateSystem(preserveAspectRatio = false)),
        Diagram(coordinateSystem(preserveAspectRatio = false, extent = {{-100, -100}, {100, 100}})),
        experiment(StopTime = 300, StartTime = 0, Tolerance = 1e-06, Interval = 0.6));
    ...
    model HPM5 "Model of a hydropower system with a simple turbine turbine"
      extends Modelica.Icons.Example;
      parameter Real TorqueScaling = 100000 "Scale down of the torque signal out";
      parameter Real GuideVaneOpeningOffset = 0.7493 "Start possition of theguide vane";
      parameter Real GuideVaneOpeningChange = -0.04615 "Change in guide vane possition";
      ...
      Modelica.Blocks.Interfaces.RealInput W_in(start = 1) annotation(
        Placement(visible = true, transformation(origin = {-120, -42}, extent = {{-20, -20}, {20, 20}}, rotation = 0), iconTransformation(origin = {-122, 0}, extent = {{-20, -20}, {20, 20}}, rotation = 0)));
      Modelica.Blocks.Sources.Constant const2(k = 52) annotation(
        Placement(visible = true, transformation(origin = {-64, -88}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
      Modelica.Blocks.Math.Add addd annotation(
        Placement(visible = true, transformation(origin = {10, -72}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
    Modelica.Blocks.Logical.GreaterEqual greaterEqual annotation(
    ...
    equation
      ...
      connect(addd.y, turbine.w_in) annotation(
        Line(points = {{21, -72}, {23, -72}, {23, -2}, {22, -2}}, color = {0, 0, 127}));
    connect(greaterEqual.u1, W_in) annotation(
        Line(points = {{-74, -58}, {-120, -58}, {-120, -42}}, color = {0, 0, 127}));
    connect(greaterEqual.y, switch1.u2) annotation(
        Line(points = {{-50, -58}, {-46, -58}, {-46, -76}, {-38, -76}}, color = {255, 0, 255}));
    connect(switch1.y, addd.u2) annotation(
        Line(points = {{-14, -76}, {-2, -76}, {-2, -78}}, color = {0, 0, 127}));
    connect(const2.y, greaterEqual.u2) annotation(
        Line(points = {{-52, -88}, {-74, -88}, {-74, -66}}, color = {0, 0, 127}));
    connect(constant1.y, switch1.u1) annotation(
        Line(points = {{-82, -86}, {-78, -86}, {-78, -72}, {-38, -72}, {-38, -68}}, color = {0, 0, 127}));
    connect(const2.y, switch1.u3) annotation(
        Line(points = {{-52, -88}, {-38, -88}, {-38, -84}}, color = {0, 0, 127}));
      annotation(
        experiment(StopTime = 300, StartTime = 0, Tolerance = 1e-06, Interval = 0.6),
        __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian --fmuCMakeBuild=true --fmuRuntimeDepends=none ",
        Diagram);
  ...
  HPM5 hpm5 annotation(
    ...
    equation
      ...
      connect(SignalChecker.Test_motor_torque_out, TM_Torque_Out) annotation(
        Line(points = {{50, 16}, {60, 16}, {60, 60}, {110, 60}}, color = {0, 0, 127}));
      connect(sMModel2.AO2, SM_torque_in) annotation(
        Line(points = {{-60, 0}, {-120, 0}}, color = {0, 0, 127}));
      connect(sMModel2.AO1, SM_speed_in) annotation(
        Line(points = {{-60, 16}, {-80, 16}, {-80, 80}, {-120, 80}}, color = {0, 0, 127}));
      connect(sMModel2.SM_start_stop_out, SM_Start_Stop_Out) annotation(
        Line(points = {{-36, 12}, {-30, 12}, {-30, 80}, {110, 80}}, color = {255, 127, 0}));
      connect(sMModel2.SM_speed_out, SM_Speed_Out) annotation(
        Line(points = {{-36, 8}, {-28, 8}, {-28, -20}, {110, -20}}, color = {0, 0, 127}));
      connect(sMModel2.SM_start_torque_out, SM_Start_Torque_out) annotation(
        Line(points = {{-36, 4}, {-34, 4}, {-34, -40}, {110, -40}}, color = {0, 0, 127}));
  connect(hpm5.W_in, sMModel2.SM_w_out) annotation(
        Line(points = {{-18, 10}, {-36, 10}, {-36, 16}}, color = {0, 0, 127}));
  connect(hpm5.Tourque_out, SignalChecker.Torque_In) annotation(
        Line(points = {{6, 18}, {12, 18}, {12, 8}, {26, 8}}, color = {0, 0, 127}));
      annotation(
        experiment(StartTime = 0, StopTime = 300, Tolerance = 1e-06, Interval = 0.6),
        __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian --fmuCMakeBuild=true --fmuRuntimeDepends=none ");
    end HydroM5;
  ...
  SMModel2 sMModel2 annotation(
    ...
    equation
      ...
      connect(hpm4.Tourque_out, SignalChecker.Torque_In) annotation(
        Line(points = {{8, 16}, {16, 16}, {16, 8}, {26, 8}}, color = {0, 0, 127}));
  connect(SM_torque_in, sMModel2.AO2) annotation(
        Line(points = {{-120, 0}, {-74, 0}, {-74, 4}, {-66, 4}}, color = {0, 0, 127}));
  connect(sMModel2.AO1, SM_speed_in) annotation(
        Line(points = {{-66, 20}, {-78, 20}, {-78, 80}, {-120, 80}}, color = {0, 0, 127}));
  connect(sMModel2.SM_w_out, hpm4.W_in) annotation(
        Line(points = {{-42, 20}, {-24, 20}, {-24, 8}, {-16, 8}}, color = {0, 0, 127}));
  connect(sMModel2.SM_start_stop_out, SM_Start_Stop_Out) annotation(
        Line(points = {{-42, 16}, {-30, 16}, {-30, 80}, {110, 80}}, color = {255, 127, 0}));
  connect(sMModel2.SM_speed_out, SM_Speed_Out) annotation(
        Line(points = {{-42, 12}, {-30, 12}, {-30, -20}, {110, -20}}, color = {0, 0, 127}));
  connect(sMModel2.SM_start_torque_out, SM_Start_Torque_out) annotation(
        Line(points = {{-42, 8}, {-34, 8}, {-34, -40}, {110, -40}}, color = {0, 0, 127}));
      annotation(
        experiment(StartTime = 0, StopTime = 300, Tolerance = 1e-06, Interval = 0.6),
        __OpenModelica_commandLineOptions = "--matchingAlgorithm=PFPlusExt --indexReductionMethod=dynamicStateSelection -d=initialization,NLSanalyticJacobian --fmuCMakeBuild=true --fmuRuntimeDepends=none ");
    end HydroM6;
